  ...
  return (
    <div className="p-5 rounded-lg bg-primary text-white">
      ...
      <div className="flex my-2 ">
        <div className="w-20 bg-white bg-opacity-20 flex p-4 cursor-pointer mx-2 border-white border-opacity-10 border-2 rounded-lg hover:border-opacity-100">
          <img
            className="my-auto"
        ...
        <div className="w-20 bg-white bg-opacity-20 flex p-2 cursor-pointer mx-2 border-white border-opacity-10 border-2 rounded-lg hover:border-opacity-100">
          <img
            className="my-auto"
